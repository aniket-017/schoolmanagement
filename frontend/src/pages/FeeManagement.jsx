    ...
    <Layout>
      <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-8">
        ...
        <motion.div variants={itemVariants} className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
          <div>
            <h1 className="text-3xl font-bold text-secondary-900 mb-2">Fee Management</h1>
            <p className="text-secondary-600">Monitor payments, track fees, and manage financial records</p>
          </div>
          ...
          <div className="p-6">
            {activeTab === "overview" && (
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  {/* Monthly Collection */}
                  <div>
                    <h3 className="text-lg font-semibold text-secondary-900 mb-4">Monthly Collection</h3>
                      ...
                      {feeBreakdown.map((fee, index) => (
                        <div key={index} className="flex items-center justify-between">
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="text-sm text-secondary-700">{fee.name}</span>
                          </div>
                          <span className="text-sm font-medium text-secondary-900">${fee.amount.toLocaleString()}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                      ...
                      {filteredPayments.map((payment) => (
                        <tr key={payment.id} className="hover:bg-secondary-50 transition-colors">
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div>
                              <div className="text-sm font-medium text-secondary-900">{payment.studentName}</div>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            ...
                            <div className="text-sm text-secondary-500">{payment.method}</div>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-secondary-900">{payment.feeType}</td>
            ...
            {activeTab === "reports" && (
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-secondary-900 mb-2">Financial Reports</h3>
