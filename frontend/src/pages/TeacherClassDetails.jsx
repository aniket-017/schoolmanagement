              ...
              {students.length > 0 ? (
                <>
                  <div className="mb-3 text-center">
                    <p className="text-sm text-gray-500">Click on any student to view their profile</p>
                  </div>
                    ...
                    {[...students]
                      ...
                      .map((student, index) => (
                        <motion.div
                          ...
                          className="bg-gray-50 rounded-lg p-3 hover:bg-gray-100 hover:shadow-md transition-all duration-200 cursor-pointer border border-transparent hover:border-blue-200"
                          onClick={() =>
                            navigate(`/teacher/classes/${classId}/students/${student._id}`, {
                              state: { student },
                            })
                          }
                        >
